...
imhere.MetroAPI.prototype.getNearestStation = function(position) {
	var def = new $.Deferred;
	position.radius='200';
...
imhere.MetroAPI.prototype.getTrainInformation = function(nearestrailway) {
	...
	query.condition={prop:'odpt:railway', value:nearestrailway.sameas};
	...
	var options = {
        ...
        success: function(d, dt) {
			...
			if (d.length > 0) {
				...
				alert(ret.trainInformationText);
