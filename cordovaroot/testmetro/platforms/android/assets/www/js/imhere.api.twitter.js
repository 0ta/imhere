imhere.TwitterAPI = function(at, ats) {
    ...
    //this.busy = false;
    this.consumer = {
        consumerKey: 'rpBgofInKQAd3uaBoI0dkkD6u',
        consumerSecret: 'xhXTIqnfpHzKwmzfKxc2saph3d3712Ky5nEFBrhghm11KSqA9G'
    };
    this.token = '';
    this.token_secret = '';
    this.atoken = at;
...
imhere.TwitterAPI.prototype.post = function(api, content, callback) {
    var accessor = {
        consumerSecret: this.consumer.consumerSecret,
